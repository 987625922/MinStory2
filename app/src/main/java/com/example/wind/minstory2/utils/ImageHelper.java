package com.example.wind.minstory2.utils;
...
/**
 * Created by caption on 2016/2/23.
 */
public class ImageHelper {
    ...
    public static String bitmap2ToBase64(Bitmap bitmap) throws IOException {
        String result = null;
    ...
    public static Bitmap bitmapCompress(Bitmap image) throws IOException {
